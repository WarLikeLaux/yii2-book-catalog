...
- `git status --porcelain` - краткий список всех измененных и новых файлов.
...
1. Используй СТРОГО `make d`, чтобы увидеть все изменения (включая контент новых файлов). Это единственная команда, которая выводит диффы по старым и новым файлам одновременно. Используй `git status --porcelain` только для получения списка путей.
