...
final class SubscriptionRepositoryTest extends Unit
{
    ...
    public function testExistsReturnsTrueWhenSubscriptionExists(): void
    {
        ...
        $this->assertTrue($this->repository->exists('+77001234567', $authorId));
    }
    ...
    public function testExistsReturnsFalseWhenSubscriptionMissing(): void
    {
        ...
        $this->assertFalse($this->repository->exists('+77001234567', $authorId));
    }
    ...
    public function testExistsReturnsFalseForDifferentAuthor(): void
    {
        ...
        $this->assertFalse($this->repository->exists('+77001234567', $authorId2));
    }
    ...
    public function testGetSubscriberPhonesForBookReturnsPhones(): void
    {
        ...
        $phones = iterator_to_array($this->repository->getSubscriberPhonesForBook($bookId, 100));
