---
name: humanize
description: AI writing tropes checker - detects and eliminates common AI writing patterns that make text sound artificial. Based on tropes.fyi rules plus extra typography rules.
---

# AI Writing Tropes to Avoid

Apply these rules to ALL text you generate in this session. After generating any text, self-check against every section below and rewrite violations.
