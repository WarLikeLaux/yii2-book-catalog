...
**Modern Clean Architecture • PHP 8.4 • Async Queues • Hybrid Search (FullText + LIKE)**
...
>
> Конечно, я позволил себе немного прагматизма (о компромиссах читайте [ниже](#14-прагматизм-и-компромиссы)), чтобы не превращать разработку в ад, но в целом — это пример того, как делать **качественно** и **надолго**.
...
- [🏗 Архитектурные решения](#-архитектурные-решения)
  - [1-5. Application, Domain, Presentation, Infrastructure](#1-application-layer-use-cases-cqs-ports)
  - [6-12. DTO, Forms, DI, Search, Pagination](#6-dto--forms-для-валидации)
  - [13. Структура проекта](#13-структура-проекта)
  - [14. Прагматизм и компромиссы](#14-прагматизм-и-компромиссы)
...
| 🔹 **CQS Pattern**<br>Разделение команд и запросов | 🔍 **Hybrid Search**<br>FullText + LIKE fallback |
...
| ✅ **PHPStan Level 9**<br>Custom Rules | 🛠 **Makefile**<br>Автоматизация рутины |
| ✅ **Mutation Testing**<br>Infection PHP (MSI 100%) | 📚 **Docs Generation**<br>Yii2 API + OpenAPI |
| ✅ **Automated Refactoring**<br>Rector | 🏗 **Architecture Checks**<br>Deptrac |
...
- `make test` — 🧪 Запуск основных тестов (Unit + Integration + Coverage)
- `make dev` — 🛡️ Авто-фикс стиля и статический анализ (запускать перед коммитом)
...
#### 14.1. Репозитории используют ActiveRecord для запросов
...
#### 14.2. Использование Yii2 компонентов в слое Presentation
...
#### 14.4. Прагматичная валидация (No Validator Classes)
...
#### 14.5. Асинхронные события через маркер + маппер
