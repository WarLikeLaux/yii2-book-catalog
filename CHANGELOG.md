...
## [0.13.0] - 2026-01-01 — "Спецификации и политики"

> Внедрен паттерн «Спецификация» для гибкого поиска и фильтрации книг, а также доменные политики для выноса сложной логики из сущностей. Архитектура стала еще более независимой: маппинг событий в задачи очереди теперь полностью скрыт в инфраструктуре через `EventToJobMapper`. Локализация консолидирована в едином файле `app.php`. Достигнуто 100% покрытие кода тестами и 100% MSI (мутационное тестирование).
