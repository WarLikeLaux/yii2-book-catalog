...
> Наконец-то доменные сущности стали по-настоящему богатыми — валидация, бизнес-логика, всё внутри. Реализована наблюдаемость (Observability) и воркфлоу для агентов. Инфраструктура тестов переведена на современные сьюты (Integration/E2E). Покрытие кода — честные 100%. Плюс Redis-кеширование и правильный Docker-маппинг.
