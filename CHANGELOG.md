...
> Масштабное обновление, охватывающее более 120 коммитов: внедрен AutoMapper для декларативного маппинга DTO и механизм ActiveRecordHydrator для автоматизации сохранения сущностей. Реализована система хранения CAS (Content-Addressable Storage), сервис MimeTypeDetector и механизмы идемпотентности для повышения надежности очередей. Архитектура ядра формализована в ADR #13, усилена строгими правилами PHPStan и унифицированной обработкой ошибок через UseCaseHandlerTrait. Проведена глобальная стандартизация стиля кода (Prettier, PHPCS) во всех слоях и рефакторинг инструментов тестирования для стабилизации CI/CD.
