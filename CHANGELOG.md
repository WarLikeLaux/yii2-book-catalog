...
> Масштабное обновление, охватывающее более 130 коммитов: внедрен AutoMapper для декларативного маппинга DTO и механизм ActiveRecordHydrator для автоматизации сохранения сущностей. Реализована система хранения CAS (Content-Addressable Storage), сервис MimeTypeDetector и механизмы идемпотентности для повышения надежности очередей. Внедрена строго типизированная система конфигурации и проведена реорганизация (squash) миграций. Архитектура ядра формализована в ADR #13, усилена строгими правилами PHPStan и унифицированной обработкой ошибок через UseCaseHandlerTrait. Проведена глобальная стандартизация стиля кода (Prettier, PHPCS) во всех слоях и рефакторинг инструментов тестирования для стабилизации CI/CD.
...
- **#32** - обновлены бейджи в `README.md` ([e288582](https://github.com/WarLikeLaux/yii2-book-catalog/commit/e288582))
